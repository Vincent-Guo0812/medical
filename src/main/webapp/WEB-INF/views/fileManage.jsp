...
<div class="wrap-container clearfix">
    <div class="column-content-detail">
        ...
        <form class="layui-form" action="${pageContext.request.contextPath}/recoveryByIdOrDate" method="post">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <input type="text" name="ID"  placeholder="病人身份证号" autocomplete="off" class="layui-input">
                </div>

                <div class="layui-inline"> <!-- 注意：这一层元素并不是必须的 -->
                    <input type="text" name="date" class="layui-input" id="test1" placeholder="日期范围" >
                </div>
                ...
                <div style="position: relative;top: 25px">
                    <ul class="pagination">
                        <c:if test="${pageInfo.hasPreviousPage}">
                            <li>
                                <a href="${pageContext.request.contextPath}/alreadyRecovery?pn=${pageInfo.prePage}"> <span>«</span>  </a>
                            </li>
                        </c:if>
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
                            <c:if test="${pageNums == pageInfo.pageNum}">
                                <li class="active">
                                    <a href="${pageContext.request.contextPath}/alreadyRecovery?pn=${pageNums}">${pageNums}</a>
                                </li>
                            </c:if>
                            <c:if test="${pageNums != pageInfo.pageNum}">
                                <li >
                        ...
                        <c:if test="${pageInfo.hasNextPage}">
                            <li>
                                <a href="${pageContext.request.contextPath}/alreadyRecovery?pn=${pageInfo.nextPage}">    <span>»</span>  </a>
                            </li>
                        </c:if>
                        <c:if test="${!pageInfo.hasNextPage}">
                            <li class="disabled"><span>»</span></li>
