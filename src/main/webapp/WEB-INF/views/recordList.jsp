        ...
        <div class="layui-form" id="table-list">
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    <th class="hidden-xs">归 档</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${recordDTOList}" var="record">
                    <tr>
                        ...
                        <td class="hidden-xs">
                            <div class="layui-inline">
                                <a href="${pageContext.request.contextPath}/recovery?recordId=${record.id}">  <i class="layui-icon">&#xe642;</i> </a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
